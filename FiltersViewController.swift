...
//    var data as [Any] = [("Deals"), ("Distance", ["Auto", "1mi", "5mi", "10mi"]), ("Sort By", ["Best Match", "Distance", "Highest Rated"]), ("Category")]
...
*/
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return categories.count         //data[section].1.count         
    }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "SwitchCell", for: indexPath) as! SwitchTableViewCell
        //let rowsInSection = data[indexPath.section].1
        //cell.switchLabel.text = rowsInSection[indexPath.row]            
...
//        }
        //replace above code with ternary nil-coalescing operator
        cell.onSwitch.isOn = switchStates[indexPath.row] ?? false
        return cell
    }
/*
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: "HVId") as! UITableViewHeaderFooterView
